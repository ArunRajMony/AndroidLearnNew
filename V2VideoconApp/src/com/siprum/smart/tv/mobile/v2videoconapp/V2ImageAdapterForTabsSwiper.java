...
public class V2ImageAdapterForTabsSwiper extends BaseAdapter {
    ...
    List<V2ChannelDetailEnum> channelsInThisCategory = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
         ...
         */
        V2ChannelDetailEnum chDetail = channelsInThisCategory.get(position);
        imageView.setTag(chDetail);
