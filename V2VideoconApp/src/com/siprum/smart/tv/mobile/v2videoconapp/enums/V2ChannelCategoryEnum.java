...
public enum V2ChannelCategoryEnum {
	...
	public static  String getCategoryNameForPosition( int position){
		String res= null;
	...
	public static  V2ChannelCategoryEnum getCategoryEnumForPosition( int position){
		V2ChannelCategoryEnum res= null;
